      function [sys,x0] = mix3s(t,x,u,flag,Uname,Fname1,Fname2,Fname3,Ename)

%  MIX3S     Point mix for 3 streams   
%
%            For use with FOODS-LIB models   
%
%            Synopsis: S-function for 3 stream point mix steady-state 
%            model. Determines mass and energy balances. 
%   
%            Call: unitops(t,x,u,flag,Uname,Fname1,Fname2,Fname3,Ename)
%   
%            Passed Arguments:  
